...
export const PopupsScreen = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>إدارة النوافذ المنبثقة</Text>
      <TouchableOpacity style={styles.addButton}>
        <Text style={styles.addButtonText}>إضافة نافذة منبثقة جديدة</Text>
      </TouchableOpacity>
      <Text style={styles.placeholder}>قائمة النوافذ المنبثقة ستظهر هنا</Text>
    </View>
  );
};
